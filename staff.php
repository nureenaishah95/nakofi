...
$week_day = date('N', $selected_ts); // 1=Monday ... 7=Sunday
...
$display_start = date('j M', $week_start_ts);
$display_end = date('j M', $week_end_ts);
$week_label = "$display_start – $display_end";
...
<head>
    ...
    <title>Nakofi Cafe - Staff Dashboard</title>
    ...
    <style>
        ...
        *{margin:0;padding:0;box-sizing:border-box;}
        ...
        .products-search-bar input {flex-grow: 1;padding: 10px 16px;border: 1px solid var(--border);border-radius: 8px;font-size: 15px;}
        .products-search-bar button {padding: 10px 20px;background: var(--charcoal);color: white;border: none;border-radius: 8px;cursor: pointer;font-weight: 600;}
        ...
        .date-input-wrapper {
            position: relative;
            flex: 1 1 220px; /* Grow but with min width */
        }
        .date-input {
            width: 100%;
    ...
    <div class="cards-grid">
        ...
        <div class="products-row">
            ...
            <div class="chart-card">
                <div class="chart-title"><i class="fas fa-chart-pie"></i> Top Selling Products </div>
...
function applyDateFilter() {
    const displayDate = document.getElementById('datePicker').value; // dd/mm/yyyy
    if (!displayDate) return; // Prevent empty
